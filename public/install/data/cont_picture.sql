...
CREATE TABLE IF NOT EXISTS `np_picture_album` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `main_id` int(11) unsigned NOT NULL DEFAULT '' COMMENT '图文ID',
  `thumb` varchar(255) NOT NULL DEFAULT '' COMMENT '缩略图',
  `image` varchar(255) NOT NULL DEFAULT '' COMMENT '原图',
  PRIMARY KEY (`id`),
  KEY `main_id` (`main_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='图文相册表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='图文扩展表';
