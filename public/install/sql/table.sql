...
CREATE TABLE IF NOT EXISTS `np_category` (
  ...
  `title` varchar(50) NOT NULL DEFAULT '' COMMENT 'SEO标题',
  `keywords` varchar(100) NOT NULL DEFAULT '' COMMENT 'SEO关键词',
  `description` varchar(300) NOT NULL DEFAULT '' COMMENT 'SEO描述',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='模型表';
...
CREATE TABLE IF NOT EXISTS `np_node` (
  ...
  KEY `name` (`name`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8mb4 COMMENT='节点表';
...
CREATE TABLE IF NOT EXISTS `np_region` (
  ...
  KEY `pid` (`pid`),
  KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=820109 DEFAULT CHARSET=utf8mb4 COMMENT='地区表';
...
CREATE TABLE IF NOT EXISTS `np_role` (
  ...
  KEY `pid` (`pid`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='组表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='管理员组关系表';
